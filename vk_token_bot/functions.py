...
class GetVkToken(BasicDialogue):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.order = [
            ...
            ReadWriteUnit("password", "Если у вас включена двухфакторная авторизация - введите код, если нет - отправьте любое сообщение."),
    ...
    def send_token(self, update, context):
        ...
        #     update.message.reply_text(
        #         f"Ожидалась одна из опций /proxy или /no_proxy. Чтобы начать сначала, нажмите /{self.help_message}")
        #     return MessageActions.END
